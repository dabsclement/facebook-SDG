const covid19ImpactEstimator = (data) => {
  ...
  const impactHospitalBedsByRequestedTime = (totalHospitalBeds * 35) - casesByRequestedTime;
  // challenge 3
  ...
  const hospitalBedsByRequestedTime = (totalHospitalBeds * 35) - severeCasesByRequestedTime;
  // challenge 3
